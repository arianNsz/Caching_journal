...
with open('LRU.pkl', 'rb') as f:
    LRU_hits, LRU_utilization, LRU_avg_fresh, LRU_rewards = pickle.load(f)
LRU_avg_fresh = np.array(LRU_avg_fresh)
LRU_avg_fresh = LRU_avg_fresh / 3
#%%
